...
export default async function AboutPage() {
  ...
  const milestones = [
    ...
    },
    {
      ...
      event:
        "Нуждата от застроена площ ни кара да разширим производствената площ с още 400 кв.м. и инсталиране на 500 кв. м. мобилни халета за съхранение на суровини.",
              ...
              <div className="md:w-1/2 p-8 md:p-10">
                ...
                <CardContent className="p-0 text-gray-700 space-y-5 leading-relaxed text-base">
                  <p>
                    ...
                    ние разширяваме продуктовата гама с цел да удовлетворим нуждите на всеки рибар, влагайки само
